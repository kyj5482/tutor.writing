...
- **XP:** 655 (next level at 700)
- **Current streak:** 4 days (best: 5)
- **Last entry:** 2026-07-16 — 07 Golden Line
...
- [ ] **Verb agreement & tense** — clean streak: 0/3 · e.g. "Sophie and her friends knows" → "know", "he choose" → "chose", "he need"/"they ... needs" → "need(s)" · **07-16: slipped on first draft in BOTH the main entry ("knows") and the ACE ("needs"); each caught on read-aloud/revision, not before. Plural subjects are the trigger (they/Sophie and her friends → drop the ‑s). The revision fixes are getting fast — next goal is one read-aloud *before* saving so the first draft is clean.**
