...
- **Grade:** 8
- **Current book:** Neverseen by Shannon Messenger (Keeper of the Lost Cities #4) — started 2026-07-16
...
- **XP:** 735 (next level at 800 — 65 to go)
- **Current streak:** 1 day (best: 5)
- **Last entry:** 2026-07-23 — 10 Book Review
...
- [ ] **Verb agreement & tense** — clean streak: 0/3 · e.g. "Sophie and her friends knows" → "know", "he choose" → "chose", "he need"/"they ... needs" → "need(s)" · **07-23: slipped on compound subject — Book Review "the plot and the action is" → "are" (two things joined by "and" are plural). Flagged in the 🔧, not caught before saving → streak stays 0/3. Note: this is the same compound-subject pattern as 07-14 "trust and loyalty is"→"are". · 07-21: slipped again on first draft — main entry "to betray... and joined"/"to tearing down" (infinitive parallel, drop the ‑ed / plain verb after "to"), and ACE "The cache... make" → "makes" (singular subject needs the ‑s this time). All caught on flag/read-aloud, not before saving. Progress: the ACE fix came from the student's OWN read-aloud when prompted, and the plural "Sophie and her friends are" was correct on the first try. Next goal still: run the read-aloud *before* saving.**
...
| 2026-07-23 | 10 Book Review | 3 | 40 | not yet (offered) | 🎉 Finished The 39 Clues: Storm Warning (Linda Sue Park)! Strong Tier-3 hook question naming three stakes ("give up your life, home, and friends") + no-spoiler setup (Caribbean, Madrigal problem). Sharp craft read: noticed the 1st-person/3rd-person POV shift AND quoted it as proof ("While Ian Kabra is watching the Cahills....") — same POV-craft eye as the 07-14 review. Watch: verb slipped on COMPOUND subject "the plot and the action is" → "are" (same pattern as 07-14 "trust and loyalty is"→"are"), flagged not caught before save → streak stays 0/3, no +5 focus XP. Rating was flat 5/5 (didn't argue with itself) — stretch offered. ACE offered. 🎉 **Leveled up to 8 — 🪶 Voice Finder** (crossed 700). Streak reset to Day 1 (missed 07-22) — welcomed back. XP 40 (10 + T3 10 + finished-book 20). |
